...
export default function MovieCard({ movie, variant = 'browse', onRemove }) {
      ...
      <div className="p-3 flex flex-col gap-2">
        ...
        {variant === 'list' ? (
          <button
            onClick={onRemove}
            disabled={loading}
            className="text-xs py-1 rounded border border-red-500 text-red-500 hover:bg-red-500/10 disabled:opacity-50"
          >
            Remove
          </button>
        ) : (
